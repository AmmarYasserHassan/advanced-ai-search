...
public class Searcher {
	...
	static boolean useFirstHeuristic = false;
	
	public static Node genGrid(int maxWidth, int maxHeight)
	{
	...
	public static Node search(Node initialState,String strategy, boolean visualize)
	{
		...
		while(!queue.isEmpty())
		{
			...
			{
			System.out.println();
			System.out.println("----------------------------------------------------- order of current node: " + nodesExpanded );
			System.out.println();
...
//		}		
	...
	public static int estimatedCostFromANodeToTheGoal(Node node,boolean h1)
	{
	...
	public static void main(String [] args){
		...
		Node init = genGrid(10,10);
		//Node init = initialize(5,5);
		init.grid = Test.testingGrid10by102();
